...
export const INTERPRETATION_PROMPT_VERSION = "blackout-interpretation-poem-only-v2";
...
Write one short paragraph, no more than 100 words, in clear, everyday language. Return only the interpretation, without a heading or follow-up question.`;
...
// Deliberately omit temperature, top_p, reasoning, seed, token limits and
// provider routing. Store both this request and the discovered defaults.
