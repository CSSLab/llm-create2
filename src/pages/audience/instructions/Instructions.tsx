       ...
       <PageTemplate title='Your Task' background='bg2' nextButton={{text: 'Next', action: handleSubmit}}>
        <div className="w-full h-full flex-col space-y-6">
         <p className="text-main mb-2">
            The goal of this experiment is for you to read <strong>three blackout poems</strong>.
          </p>
        <div>
         <p className="text-main mb-2">
            The task involves two steps:
             ...
             <ul className="list-disc mb-4 pl-6 space-y-4">
                <li className="text-main">
                    ...
                    <p className="text-main">You will be given the three pieces. This is a time for you to read through all the works and form your initial thoughts.</p>
                ...
                <li className="text-main">
                    ...
                    <p className='text-main'>For each poem, you will fill out a quick survey letting us know what you think of the work.</p>
                </li>
