    ...
    <div className={`relative w-full h-full min-w-96 bg-white overflow-hidden p-16 md:p-20 `+ (background == "bg4" ? `bg-dark-grey` : `bg-white `)}
       >
        ...
        <img
          ...
          alt="background"
          className={`absolute top-0 left-0 w-full h-full object-none pointer-events-none select-none ` + (background == "bg5" ? `opacity-0 lg:opacity-100`: ``)}
          style={{
            zIndex: 0,
          }}
        />
      )}
        <div className={`relative z-10 h-full w-full lg:w-1/2 space-y-4 flex flex-col justify-between` + (left==undefined ? ` justify-self-start`: left? ` justify-self-start`: ` lg:justify-self-end`)}>
          <div className={`w-full h-max space-y-4`}>
            {title && (
              <div className={`w-full h-max flex ` + (background == "bg4" ? `text-h1-dark` : `text-h1`)}>
                <p>{title}</p>
              </div>
            )}
            {description && (
              <div className={`w-full h-max flex text-left text-sm font-sans font text-grey` + (background == "bg4" ? `text-h1-dark` : `text-h1`)}>
                <p>{description}</p>
              </div>
            )}
