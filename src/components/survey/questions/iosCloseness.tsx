      ...
      {CENTRE_OFFSETS.map((centreOffset, index) => {
        ...
        return (
          <button
            ...
            className={`rounded-lg border px-2 py-3 text-center transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-dark-grey ${
              selected
                ? "border-dark-grey bg-light-grey-4"
                : "border-light-grey-2 bg-white hover:border-grey"
            }`}
          >
            <svg
              viewBox="0 0 112 64"
